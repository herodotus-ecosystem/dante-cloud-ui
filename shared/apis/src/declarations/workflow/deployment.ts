import type { BpmnEntity, BpmnListParams, Link } from '../base';
...
export interface Deployment extends BpmnEntity {
  /**
...
export interface DeploymentDeploy extends BpmnEntity {
  /**
...
export interface DeploymentCreateBody {
   ...
   */
  'deployment-activation-time': Date;
  /**
...
export interface DeploymentResource extends BpmnEntity {
  /**
