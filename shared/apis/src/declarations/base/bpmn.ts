...
export type BpmnGetListParams<P extends BpmnListParams> = P & BpmnPageable;

export type BpmnPostListParams<P extends BpmnListParams, Q extends BpmnQuery> = P & BpmnPostGet<Q>;

export type DefaultBpmnListParams<P extends BpmnListParams, Q extends BpmnQuery> =
  | BpmnGetListParams<P>
