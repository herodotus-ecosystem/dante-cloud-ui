import type { AxiosHttpResult, OAuth2Token, Conditions, ConstantDictionary, EmptyObject, Entity, Page, Pageable, Pagination, Sort, Tree, BaseEntity, BaseSysEntity } from '@herodotus/core';
