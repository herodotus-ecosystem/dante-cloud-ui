...
declare class ProcessDefinitionService extends BaseBpmnService<ProcessDefinition, ProcessDefinitionListQueryParams> {
    ...
    deleteByKey(key: string, tenantId: string | undefined, query: DeleteQueryParams): Promise<AxiosHttpResult<string>>;
