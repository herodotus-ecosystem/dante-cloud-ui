<template>
  <h-center-form-layout :entity="editedItem" :title="title" :operation="operation" @save="onSave()">
    <h-text-field
      ...
      :error-message="v.editedItem.tenantId.$errors[0] ? v.editedItem.tenantId.$errors[0].$message : ''"></h-text-field>
    <h-text-field
    ...
    <h-text-field
      ...
      :error-message="
        v.editedItem.driverClassName.$errors[0] ? v.editedItem.driverClassName.$errors[0].$message : ''
      "></h-text-field>
    <h-text-field
      ...
      :error-message="v.editedItem.url.$errors[0] ? v.editedItem.url.$errors[0].$message : ''"></h-text-field>
