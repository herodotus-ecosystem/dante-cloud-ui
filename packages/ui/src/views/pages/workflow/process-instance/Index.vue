...
import type { ProcessInstance, ProcessInstanceParams } from '/@/lib/declarations';
...
export default defineComponent({
  ...
  setup() {
    const { tableRows, totalPages, pagination, loading, toEdit, toCreate, findItems, onDeleteItemById, conditions } =
      useBpmnTableItems<ProcessInstance, ProcessInstanceParams>(api.bpmnProcessInstance());
