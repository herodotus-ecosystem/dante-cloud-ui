        ...
        <v-row>
            <v-col cols="12" lg="4">
                ...
                >
                    ...
                    <h4 class="card-title font-weight-light mt-2 ml-2">平台月均访问量</h4>

                    <p class="d-inline-flex font-weight-light ml-2 mt-1">最新采集性能数据统计</p>

                    <template v-slot:actions>
                        <v-icon class="mr-1" small> mdi-clock-outline </v-icon>
                        <span class="caption grey--text font-weight-light">10分钟前</span>
                    </template>
                </h-material-chart-card>
            </v-col>
            ...
            <v-col cols="12" lg="4">
                ...
                >
                    ...
                    <h4 class="card-title font-weight-light mt-2 ml-2">平台日访问量</h4>

                    <p class="d-inline-flex font-weight-light ml-2 mt-1">
                        今日访问量环比增加&nbsp;<v-icon color="green" small> mdi-arrow-up </v-icon>
                        <span class="green--text">55%</span>&nbsp;
                    </p>

                    <template v-slot:actions>
                        <v-icon class="mr-1" small> mdi-clock-outline </v-icon>
                        <span class="caption grey--text font-weight-light">4分钟前</span>
                    </template>
                </h-material-chart-card>
            </v-col>
            ...
            <v-col cols="12" lg="4">
                ...
                >
                    ...
                    <h4 class="card-title font-weight-light mt-2 ml-2">已完成任务数</h4>

                    <p class="d-inline-flex font-weight-light ml-2 mt-1">最新采集性能数据统计</p>

                    <template v-slot:actions>
                        <v-icon class="mr-1" small> mdi-clock-outline </v-icon>
                        <span class="caption grey--text font-weight-light">26分钟前采集数据</span>
                    </template>
                </h-material-chart-card>
            </v-col>

            <v-col cols="12" sm="6" lg="3">
                <h-material-stats-card
                    color="info"
                    icon="mdi-twitter"
                    title="Followers"
                    value="+245"
            ...
            <v-col cols="12" md="6">
                <h-material-card color="warning" class="px-5 py-3">
            ...
            <v-col cols="12" md="6">
                <h-material-card class="px-5 py-3">
                    <template v-slot:heading>
...
export default class Dashboard extends Vue {
    ...
    private tasks = {
        0: [
            ...
            {
                text: '针对新增加的接口幂等功能，编写开发文档和配置手册',
                value: false,
            },
            {
                text: '最新的接口幂等功能发布至测试服务器后，编写测试用例，对新增幂等功能后平台整体运行性能进行压力测试',
                value: false,
            },
            {
                text: '修复新发现的以及已知的平台问题',
                value: true,
            },
        ],
        1: [
