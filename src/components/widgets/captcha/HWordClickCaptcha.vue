<template>
	<div>
		...
		<h-behavior-captcha-control description="请顺序点选" :size="sliderSize" :prompt="prompt"></h-behavior-captcha-control>
	</div>
</template>
...
export default defineComponent({
	...
	setup(props, { emit }) {
		...
		const { getImage, message, canOperate, isLoading, isSuccess, isShowMessage, verifyCaptcha, reset } = useBehaviorCaptcha();
